...
let firstItem = ItemToCompare(price: 15.99, weight: 16.9, weightType: .ounce)
let secondItem = ItemToCompare(price: 21.99, weight: 23.2, weightType: .ounce)

firstItem.dividePriceByWeight(item: firstItem)

let something = firstItem.dividePriceByWeight(item: firstItem)

var someNewItem = ItemToCompare(price: 40.00, weight: 2.5, weightType: .gallon)
someNewItem.weightType.convToQuarts(itemToConvert: someNewItem)
